export const signupValidation = ({
    ...
    if(!regexPassword.test(password)) errors.push('La contraseña debe contener 8 o más caracteres, al menos una mayúscula, una minúscula, un número y un símbolo no alfanumérico.')
